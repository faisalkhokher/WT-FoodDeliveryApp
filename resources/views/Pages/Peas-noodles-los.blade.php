...
<!-- Mirrored from market.spidersx.com/Avocada/en/Foods/peas-noodles-los by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jul 2021 08:51:26 GMT -->
...
<head>
 ...
 <link rel="manifest" href="images/imagesmanifest.json">
 <!-- ====== SiteTitle ========================================================================== -->
 <title>Avocada</title>
 <!-- ===========================================  googleapis =================================== -->
...
<div class="uk-section uk-dark uk-background-cover" style="background-image: url('../../images/images/breadcrumbs.jpg')">
  <div class="uk-container uk-container-xlarge">
    <h2 class="uk-heading-small">Peas Noodles Los</h2> 
    <ul class="uk-breadcrumb">
      <li class="uk-button uk-button-text"><a href="{{route('layouts.frontend')}}">Home</a></li>
      <li><span>Peas Noodles Los</span></li>
    </ul>          
  </div>
</div>
<!-- =============================================================  content ================================================= -->
  ...
  <div class="uk-container uk-container-xlarge">
    <div data-uk-grid>
     <div class="uk-width-expand">
            <img class="uk-border-10" data-src=images/images/5ed3d03e3773bfood-3.png" width="100%" alt="Pfarrgasse 20, 4020 Linz" uk-img>
          ...
          <div class="uk-width-1-1">
            <article class="uk-article">
              <ul class="uk-comment-meta uk-subnav uk-subnav-divider uk-margin-remove-top">
                ...
                <li><a class="uk-color-2"><span uk-icon="icon: clock; ratio: 0.8"></span> 11:00 - 14:0016:00 - 18:30 . €19.5 Usd</a></li>
                                <li><a class="uk-cat">Noodles </a></li>
                              </ul>
...
anderen tierischen Produkten aus und sind somit 100% vegan. </p> 
          ...
          <div class="uk-width-expand@m">
            <div class="uk-article">
              ...
              <h3><span class="uk-margin-small-right" uk-icon="commenting"></span> 2 Comments</h3>
                  ...
                  <header class="uk-comment-header uk-position-relative">
                    <div class="uk-grid-medium uk-flex-middle" data-uk-grid>
                      <div class="uk-width-auto">
                                                <img class="uk-comment-avatar uk-border-circle" src="../../images/images/5ed3cb5d2ab6eavatar.png" 
                        width="50" height="50" alt="Avocada">
                                              </div>
                      <div class="uk-width-expand">
                        <h4 class="uk-comment-title uk-margin-remove">
                                                    <a class="uk-link-reset">Avocada</a>
                                                  </h4>
                        <p class="uk-comment-meta uk-margin-remove-top"><a class="uk-link-reset">
                          <span class="uk-margin-small-right" uk-icon="calendar"></span>Jun 4, 2020</a></p>
                        </div>
                      </div>
                      <div class="uk-position-top-right uk-position-small uk-hidden-hover">
                        <a class="uk-button uk-button-small uk-button-primary uk-margin-right" href="#modal-example" uk-toggle>Reply Comment</a>
                        <form class="display-inline" action="https://market.spidersx.com/Avocada/en/Comments/29" method="POST">
                          <input type="hidden" name="_token" value="gfwJJIzXpp0Es4r8wpFshbD3UB7ulFwMzGRUvcbo">                          <input type="hidden" name="_method" value="DELETE">                          <p class="uk-margin-remove"><button class="uk-button uk-button-small uk-button-danger" type="submit">Delete</button></p>
                        </form>
                      </div>
                    </header>
                    <div class="uk-comment-body">
                      <p>kommen alle von uns angebotenen Produkte jedoch völlig ohne Fleisch oder anderen tierischen Produkten aus und sind somit 100% vegan.</p>
                    </div>
                  </article>
                </li>
                ...
                <article class="uk-comment uk-comment-primary uk-visible-toggle uk-border-rounded" tabindex="-1">
                  <header class="uk-comment-header uk-position-relative">
                    <div class="uk-grid-medium uk-flex-middle" data-uk-grid>
                      ...
                      <div class="uk-position-top-right uk-position-small uk-hidden-hover">
                        <a class="uk-button uk-button-small uk-button-primary uk-margin-right" href="#modal-example" uk-toggle>Reply Comment</a>
                        <form class="display-inline" action="https://market.spidersx.com/Avocada/en/Comments/30" method="POST">
                          <input type="hidden" name="_token" value="gfwJJIzXpp0Es4r8wpFshbD3UB7ulFwMzGRUvcbo">                          <input type="hidden" name="_method" value="DELETE">                          <p class="uk-margin-remove"><button class="uk-button uk-button-small uk-button-danger" type="submit">Delete</button></p>
                        </form>
                      </div>
                    </header>
              ...
              <div id="modal-example" uk-modal>
                <div class="uk-modal-dialog uk-modal-body">
                  ...
                  <form  method="post" action="https://market.spidersx.com/Avocada/en/Comments">
                    ...
                    <input type="text" name="Post_id" hidden="" value="115">
                    <div class="uk-margin">
  ...
  <div class="uk-container uk-container-xlarge  uk-text-500">
    ...
    <div class="uk-text-small uk-text-muted uk-margin-medium-top">        
      <div>All rights reserved 2020  Made by a <a class="uk-link-muted" target="_blank">Meteors</a>
                <a  class="uk-link-muted" rel="alternate" hreflang="en" href="peas-noodles-los.html">
          English
        </a>
                <a  class="uk-link-muted" rel="alternate" hreflang="fr" href="../../fr/Foods/peas-noodles-los.html">
          Français
        </a>
                <a  class="uk-link-muted" rel="alternate" hreflang="ar" href="../../ar/Foods/peas-noodles-los.html">
          العربية
        </a>
        .
...
<!-- Mirrored from market.spidersx.com/Avocada/en/Foods/peas-noodles-los by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jul 2021 08:51:27 GMT -->
</html>