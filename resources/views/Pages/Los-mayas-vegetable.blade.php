...
<!-- Mirrored from market.spidersx.com/Avocada/en/Foods/los-mayas-vegetables by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jul 2021 08:51:22 GMT -->
  ...
  <div class="uk-container uk-container-xlarge">
    <div data-uk-grid>
     <div class="uk-width-expand">
            <img class="uk-border-10" data-src="images/images/5ed3cfc6c950efood-1.png" width="100%" alt="Pfarrgasse 20, 4020 Linz" uk-img>
                  ...
                  <header class="uk-comment-header uk-position-relative">
                    <div class="uk-grid-medium uk-flex-middle" data-uk-grid>
                      <div class="uk-width-auto">
                        ...
                        width="50" height="50" alt="booty">
                                              </div>
                      <div class="uk-width-expand">
                        <h4 class="uk-comment-title uk-margin-remove">
                                                    <a class="uk-link-reset">booty</a>
                                                  </h4>
                        <p class="uk-comment-meta uk-margin-remove-top"><a class="uk-link-reset">
                          <span class="uk-margin-small-right" uk-icon="calendar"></span>Aug 1, 2020</a></p>
                        </div>
                      </div>
                      <div class="uk-position-top-right uk-position-small uk-hidden-hover">
                        ...
                        <form class="display-inline" action="https://market.spidersx.com/Avocada/en/Comments/36" method="POST">
                ...
                <article class="uk-comment uk-comment-primary uk-visible-toggle uk-border-rounded" tabindex="-1">
                  <header class="uk-comment-header uk-position-relative">
                    <div class="uk-grid-medium uk-flex-middle" data-uk-grid>
                      <div class="uk-width-auto">
                                                <img class="uk-comment-avatar uk-border-circle" src="../../images/images/5ed3cb5d2ab6eavatar.png" 
                        width="50" height="50" alt="zeze">
                                              </div>
                      <div class="uk-width-expand">
                        <h4 class="uk-comment-title uk-margin-remove">
                                                    <a class="uk-link-reset">zeze</a>
                                                  </h4>
                        <p class="uk-comment-meta uk-margin-remove-top"><a class="uk-link-reset">
                          <span class="uk-margin-small-right" uk-icon="calendar"></span>Feb 21, 2021</a></p>
                        </div>
                      </div>
                      <div class="uk-position-top-right uk-position-small uk-hidden-hover">
                        <a class="uk-button uk-button-small uk-button-primary uk-margin-right" href="#modal-example" uk-toggle>Reply Comment</a>
                        <form class="display-inline" action="https://market.spidersx.com/Avocada/en/Comments/38" method="POST">
                          <input type="hidden" name="_token" value="gfwJJIzXpp0Es4r8wpFshbD3UB7ulFwMzGRUvcbo">                          <input type="hidden" name="_method" value="DELETE">                          <p class="uk-margin-remove"><button class="uk-button uk-button-small uk-button-danger" type="submit">Delete</button></p>
                        </form>
                      </div>
                    </header>
              ...
              <div id="modal-example" uk-modal>
                <div class="uk-modal-dialog uk-modal-body">
                  ...
                  <form  method="post" action="https://market.spidersx.com/Avocada/en/Comments">
                    ...
                    <input type="text" name="Post_id" hidden="" value="113">
                    <div class="uk-margin">
  ...
  <div class="uk-container uk-container-xlarge  uk-text-500">
    ...
    <div class="uk-text-small uk-text-muted uk-margin-medium-top">        
      <div>All rights reserved 2020  Made by a <a class="uk-link-muted" target="_blank">Meteors</a>
                <a  class="uk-link-muted" rel="alternate" hreflang="en" href="los-mayas-vegetables.html">
          English
        </a>
                <a  class="uk-link-muted" rel="alternate" hreflang="fr" href="../../fr/Foods/los-mayas-vegetables.html">
          Français
        </a>
                <a  class="uk-link-muted" rel="alternate" hreflang="ar" href="../../ar/Foods/los-mayas-vegetables.html">
          العربية
        </a>
        .
...
<!-- Mirrored from market.spidersx.com/Avocada/en/Foods/los-mayas-vegetables by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jul 2021 08:51:24 GMT -->
</html>